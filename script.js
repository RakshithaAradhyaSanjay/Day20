        ...
        .then(data => {
            ...
            data.forEach(country => {
                ...
                button.addEventListener("click", () => {
                    ...
                    // Use country.name or country.latlng as needed
                    // Update cardBody with weather information
...
function fetchWeather(country) {
    ...
    const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${country.name}&appid=${apiKey}`;
    ...
    fetch(apiUrl)
        ...
        .catch(error => {
            ...
            cardBody.innerHTML = 'Error fetching weather data. Please try again later.';
        });
}
